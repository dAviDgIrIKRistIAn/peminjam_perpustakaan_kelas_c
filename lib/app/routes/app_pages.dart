...
import '../modules/namahalaman/bindings/namahalaman_binding.dart';
import '../modules/namahalaman/views/namahalaman_view.dart';
...
class AppPages {
  ...
  static final routes = [
    ...
    GetPage(
      name: _Paths.NAMAHALAMAN,
      page: () => const NamahalamanView(),
      binding: NamahalamanBinding(),
    ),
    GetPage(
      name: _Paths.LOGIN,
